...
% 重要提示的颜色
\definecolor{importcolor}{RGB}{213,70,39}
...
\textcolor{importcolor}{\bfseries 构建（平衡）KD-Tree}：选择高维向量中的某一维（一般采用轮转的方式），按照当前结点上的数据在该维度的中位数进行划分，直到结点不包含数据点为止。


\textcolor{importcolor}{\bfseries KD-Tree检索}：
